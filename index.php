...
$SteamAPIKey = "EE24695262427C743D046206EE867E37";
    ...
    <div class="core-wrapper"><!-- Opens the wrapper so we can contain and center everything -->
    	...
    	<div id="left-items"><!-- Opens the wrapper for the left content, there isn't really much to change on the left side as it's dynamic -->
            ...
            <div class="title server">
            	<h2>Serveur</h2><!-- Adds in the server title, you can change the text to be whatever you would like -->
           	</div>
            
            <!-- Lets get the server Details in here -->
            <ul id="server-list">
            	<li><img src="images/server-name.png" alt="Server Name" /> <span id="s-name">CityRolePlay</span></li><!-- Dynamically adds the server name -->
                <li><img src="images/server-mode.png" alt="Game Mode" /> <span id="s-mode">DarkRP</span></li><!-- Dynamically adds game mode name -->
                <li><img src="images/server-map.png" alt="Map Name" /> <span id="s-map">rp_rockford_v1b</span></li><!-- Dynamically adds map name -->
           	</ul>
        ...
        <div id="right-items"><!-- Open wrapper for the items on the right -->
            ...
            <div class="title">
            	<h2>REGLES</h2><!-- Adds in the rules title, you can change the text to be whatever you would like -->
           	</div>
            
            <!-- Let's add in all the rules, the number inside the <span></span> tags will appear in a brighter coloured box  -->
            <ul id="rules">
            	<li><span>1</span> Pas de Prop-block !</li>
                <li><span>2</span> Jouer RolePlay !</li>
                <li><span>3</span> Pas de Prop-surf !</li>
                <li><span>4</span> Pas de NLR (NewLifeRule) !</li>
                <li><span>5</span> Pas de Prop-kill/Push !</li>
                <li><span>6</span> Pas de Metagaming !</li>
                <li><span>7</span> Pas de Prop-spamming !</li>
                <li><span>8</span> Respecter le STAFF !</li>
                <li><span>9</span> Pas d'insultes OOC !</li>
                <li><span>10</span> Bon JEU :) !</li>
            </ul>
